    ...
    <main className="container py-4 py-md-5">
      <div className="row g-4">
        <div className="col-12">
          <RequirementsNav currentPath="/requirements/functional" />
        </div>
        <div className="col-12">
          <div className="card section-card">
            <div className="card-body p-4 p-md-5">
              <h1 className="display-6 fw-bold">Functional requirements</h1>
              <p className="text-muted mb-0">
                These requirements describe what the doctor booking system must do.
              </p>
            </div>
          </div>
        </div>
